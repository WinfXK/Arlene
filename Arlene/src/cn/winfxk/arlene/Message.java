...
public class Message {
	...
	public String getSun(String t, String Son, String Sun, FormBase form) {
		...
		if (object != null && object instanceof Map)
			return getText(((Map<String, Object>) object).get(Sun), form.getKey(), form.getData(), form.getPlayer());
		return null;
	}
	...
	public String getSon(String t, String Son, FormBase form) {
		...
		if (object == null || !(object instanceof Map))
			return null;
		return getText(((Map<String, Object>) object).get(Son), form.getKey(), form.getData(), form.getPlayer());
	}
	...
	public String getMessage(String t, FormBase form) {
		return getText(map.get(t), form.getKey(), form.getData(), form.getPlayer());
	}
	...
	public String getText(Object object, FormBase form) {
		return getText(object, form.getKey(), form.getData(), form.getPlayer());
	}
